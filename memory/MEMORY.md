...
- [Aesthetic reference: "old tv frontend"](reference_old_tv_frontend.md) — YouTube video defining the visual/design language when user says "old tv frontend"
- [Aesthetic reference: "old mp3 audio player"](reference_old_mp3_audio_player.md) — screenshot of a classic skeuomorphic MP3 player bar; visual target for audio UI elements
